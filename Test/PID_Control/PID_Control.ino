...
const int chA = 10; //channel 1 pin
const int chB = 11; //channel 2 pin
...
int motor1pin2 = 12; // N2 on LEFT motor controller
...
void loop() {
  ...
  ch1 = pulseIn(chA, HIGH, 25000); //steering
  ...
  Serial.print("PWM Value:"); //Prints channel readings on Serial Monitor
